...
const MultiplayerDraft = ({
	...
	const { settings, actions, draft, isBlue, readyCheck, setReadyCheck } =
		useFirestoreDraft(setNavigationContent, spectators, update, true);
	...
	useEffect(() => {
		...
		// 			settings.setOn(message.content)
		// 		);
		// 		break;
		// 	case 'CONFIRM_TIMER_TOGGLE_REQUEST':
		// 		settings.setOn(message.content);
		// 		break;
		// 	default:
		// 		break;
